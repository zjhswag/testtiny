  ...
  "node_modules/tinymce/plugins/link/plugin.js"() {
    (function() {
      ...
      const register$1 = (editor) => {
        ...
        registerOption("link_list", { processor: (value2) => isString(value2) || isFunction(value2) || isArrayOf(value2, isObject) });
      ...
      const register = (editor) => {
        editor.addCommand("mceLink", (_ui, value2) => {
          if ((value2 === null || value2 === void 0 ? void 0 : value2.dialog) === true || !useQuickLink(editor)) {
            open(editor);
          } else {
