...
*/(function(C){"use strict";let d=tinymce,_=d.util.Tools,f=d.html.Node;d.html.Schema;let G=d.util.XHR,A=d.util.I18n,X=new d.html.Serializer().serialize,Y=new d.html.DomParser().parse,b={};window.tp$State=b;let h=(t,a)=>{let n=a?a.match(new RegExp(t+':(.+?)"?[;}]')):"";return n?n[1]:!1};function H(t,a,n,e){t.tp$Style.mapping&&t.tp$Style.mapping[""+a.getAttribute("data-id")]&&(t.tp$Style.mapping[""+a.getAttribute("data-id")].specialStyle[""+n]=e)}let g={customTags:{}},L=Object.keys,m=function(){return m=Object.assign||function(a){for(var n,e=1,i=arguments.length;e<i;e++){n=arguments[e];for(var o in n)Object.prototype.hasOwnProperty.call(n,o)&&(a[o]=n[o])}return a},m.apply(this,arguments)},Z=Object.hasOwnProperty;var Q=function(t){return t==null},tt=function(t){return!Q(t)};const v=t=>{if(typeof t=="object")return JSON.stringify(t).replace(/"([-A-Za-z]+?)":""[,}]/g,"").replace(/,/gi,";").replace(/{/gi,"").replace(/}/gi,"").replace(/"/gi,"")},F=t=>typeof t=="string"&&t!=="{}"?(t=JSON.stringify(t),JSON.parse(("{"+t.replace(/:/g,'": "').replace(/;\s*/g,'","')+"}").replace(/,\"\"\}$/,"}"))):t,k=(t,a)=>{const n=a.match(new RegExp(`.${t}\\s*\\{([\\s\\S]+)\\}`));return n&&n[1]?n[1].replace(/\}([\s\S]+)/,"").trim():""};var et=function(t,a){return Z.call(t,a)},at=function(t,a,n,e){e===void 0&&(e=null);var i=t.attr(n);return tt(i)?i:et(a,n)?null:e};const B=t=>t.replace(/[-|\_](\w)/g,function(a,n){return n.toUpperCase()}),nt=t=>t.replace(/([A-Z])/g,"_$1").toLowerCase().replace(/\-/g,"_"),it=t=>t.replace(/([A-Z])/g,"-$1").toLowerCase().replace(/\_/g,"-");var ot=function(t,a){let n="";if(!t)return"";for(a=B(a);t.nodeName!=="P"&&t.nodeName!=="LI"&&t.nodeName!=="DIV"&&t.nodeName!=="BODY";){if(t.style[a]){n=t.style[a];break}t=t.parentNode}return n};let E=(t,a)=>{let n="";return n+=t["tp-buttons"]?'.tp-buttons[data-tp-style="'+a+'"] {'+t["tp-buttons"]+`}
...
`:"",n};const st=(t,a,n)=>{!n&&(n=a*100);let e={id:null,outTime:n,outId:null};e.id=setInterval(i=>{t(()=>{clearTimeout(i.outId),clearInterval(i.id)})},a,e),e.outId=setTimeout(()=>{e.id&&clearInterval(e.id)},e.outTime)};let y=function(t,a){return typeof t[a]=="function"?t[a]:typeof g.customTags[t.name][a]=="function"?g.customTags[t.name][a]:function(){}};const lt=(t,a)=>a?typeof t=="string"&&!t.match(/\s/)&&t.length>0?parseInt(t)+"px":t:typeof t=="string"&&t.length>0&&t.match(/^[0-9]{1,8}$/)?t+"px":t,T=t=>{let a=t.split("_");return a.length>1?A.translate([a[0]+" {0}",a[1]]):A.translate(t)};tinymce.tp$HtmlPanelFn=window.tp$HtmlPanelFn=function(t,a,n){b.buttonsStyle&&(b.buttonsStyle[a]=n),document.querySelector("#"+a+"_StyleID").innerHTML=t.nextElementSibling.innerHTML};const rt={count:0},ut=t=>{let a=new Date().getTime()+"-"+rt.count++,n=`
...
`;return document.querySelector(t.selector).outerHTML=n+document.querySelector(t.selector).outerHTML,a},pt=(t,a,n)=>{let e="";e=b.buttonsStyle&&b.buttonsStyle[a],n||(n=L(t.tp$CustomTags.buttons.styleSheetList)),e||(e=b.buttonsStyle&&(b.buttonsStyle[a]=n[0]));let i="",o="",r="";return n.forEach((s,l)=>{s===e&&(o=`<span class="tp-buttons" data-tp-style="${s}">${T(s)}</span>`),i+=`<li ><input id="${a+"_"+l}" type="radio" name="${a}" ${e===s?" checked ":""}  onclick="tinymce.tp$HtmlPanelFn(this,'${a}','${s}')"> <label for="${a+"_"+l}" > <span class="tp-buttons" data-tp-style="${s}">${T(s)}</span></label></li>
`,r+=E(t.tp$CustomTags.buttons.styleSheetList[s],s)}),`<div style="width: 100%; position: relative; " >
  ...
  .tox .tox-dialog__body-content li{
    ...
    ${r.replace(/.tp-buttons/g,".tox .tox-dialog__body-content .tp-buttons")}
     </style>
  ...
  :host {
      overflow: hidden;
      display: block; 
  }`,o.innerHTML=e.template.innerHTML;class l extends t.HTMLElement{constructor(){super();this.setAttribute("contenteditable",!1),this.setAttribute("data-mce-tp-component",i),this.attachShadow({mode:"open"}),this.tp$state=typeof e.state=="object"?JSON.parse(JSON.stringify(e.state)):{},D(n,this,"init",e),this.tpComponentDelete=typeof e.tpComponentDelete=="function"?e.tpComponentDelete.bind(this):()=>{this.remove()},this.tpComponentCmd=typeof e.tpComponentCmdFn=="object"?JSON.stringify(e.tpComponentCmdFn)!=="{}"?(c,x)=>{e.tpComponentCmdFn[c](this,x),D(n,this,c,e)}:(c,x)=>{g.customTags[i].tpComponentCmdFn[c](this,x),D(n,this,c,e)}:()=>{console.log("\u65E0\u53EF\u7528cmd")},s.id="tpComponentStyle_"+this.getAttribute("data-id"),i=="tabs"&&(s.textContent=e.styleSheetLoadList&&e.styleSheetLoadList[this.getAttribute("data-tp-style")||"default"]?e.styleSheetLoadList[this.getAttribute("data-tp-style")||"default"].replace(/.tp-tabs\s*\{/g,":host   {").replace(/.tp-tabs_label\b\s/g,"::slotted(.tp-tabs_label)   ").replace(/.tp-tabs_label:hover\b\s/g,"::slotted(.tp-tabs_label:hover)   ").replace(/.tp-tabs_label.checked\b\s/g,"::slotted(.tp-tabs_label.checked)   "):""),i=="collapse"&&(s.textContent=e.styleSheetLoadList&&e.styleSheetLoadList[this.getAttribute("data-tp-style")||"default"]?e.styleSheetLoadList[this.getAttribute("data-tp-style")||"default"].replace(/>/g," ").replace(/.tp-collapse\s*\{/g,":host   {").replace(/label.tp-collapse_label\b\s/g,"::slotted(.tp-collapse_label)   ").replace(/label.tp-collapse_label::/g,"::slotted(.tp-collapse_label)::").replace(/.tp-tabs_label:hover\b\s/g,"::slotted(.tp-tabs_label:hover)   ").replace(/.tp-tabs_label.checked\b\s/g,"::slotted(.tp-tabs_label.checked)   "):""),i=="buttons"&&(s.textContent=e.styleSheetList&&e.styleSheetList[this.getAttribute("data-tp-style")||"default"]?E(e.styleSheetList[this.getAttribute("data-tp-style")||"default"],this.getAttribute("data-tp-style")||"default").replace(/\[data-tp-style=(.*?)\]/g,"").replace(/>/g," ").replace(/.tp-buttons\s*\{/g,":host   {").replace(/.tp-buttons:hover\s*\{/g,":host(:hover)   {").replace(/.tp-buttons::before\s*\{/g,":host(.tp-buttons)::before   {").replace(/.tp-buttons::after\s*\{/g,":host(.tp-buttons)::after   {"):""),o.content.prepend(s),o.content.prepend(r),this.shadowRoot.appendChild(o.content.cloneNode(!0))}connectedCallback(){y(e,"headerEditableFn")(this,e.isHeaderEditable,i,n),y(e,"contentEditableFn")(this,e.isContentEditable,i,n),y(e,"connectedCallback")(this.shadowRoot,this)}static get observedAttributes(){return["data-top-bg","data-mce-tp-component","data-value"]}static tp$Delete(){console.log(this)}}try{t.customElements.define("tp-"+i,l)}catch{}},gt=t=>{const a=t.getWin(),n=t.getDoc();let e=t.toolbar,i=t.baseURI.source;typeof e=="object"&&(e=e.jion(" ")),/tpIconlists/.test(e)&&G.send({url:i+"plugins/tpIconlists/tpIconlists.css",async:!1,dataType:"text",success:function(s){t.dom.addStyle(s)}}),ct(t),dt(t);const o=`.mce-content-body [data-mce-tp-component][contenteditable=false][data-mce-selected] {
      outline: none;
      cursor: default;
  ...
  .mce-content-body *[contentEditable=false] *[contentEditable=true]:hover {
      outline: none!important;
  }`;t.dom.addStyle(o),t.tp$Style={},t.getTpStyle=s=>"<style>"+t.tp$OutputStyle+" </style>";let r=t.tp$CustomTags||g.customTags;_.each(r,function(s,l){ht(a,n,t,s,l)}),t.parser.addAttributeFilter("data-tp-component",s=>{s&&s.forEach(l=>{let u=l.attr("data-tp-component");r[u]&&y(r[u],"parserFn")(l,u,t)})}),t.serializer.addAttributeFilter("data-mce-tp-component",s=>{s&&s.forEach(l=>{let u=l.attr("data-mce-tp-component");r[u]&&y(r[u],"serializerFn")(l,u,t)})}),t.setContent(t.getContent({source_view:!0}))},I=(t,a,n,e,i)=>{e?(!e.tp$CustomTags&&(e.tp$CustomTags=JSON.parse(JSON.stringify(g.customTags))),i?m(e.tp$CustomTags[t][a],n):e.tp$CustomTags[t][a]=n):i?m(g.customTags[t][a],n):g.customTags[t][a]=n},M={custom_elements:"",setCustomTags:I,createCustomTags:(t,a,n)=>{n?(!n.tp$CustomTags&&(n.tp$CustomTags=JSON.parse(JSON.stringify(g.customTags))),n.tp$CustomTags[t]=a):g.customTags[t]=a},setStyleSheetList:(t,a,n,e)=>{I("buttons","styleSheetList",{[a]:{"tp-buttons":k("tp-buttons",n),"tp-buttons:hover":k("tp-buttons:hover",n),"tp-buttons::before":k("tp-buttons::before",n),"tp-buttons::after":k("tp-buttons::after",n)}},e,!0)},createHtmlPanel:pt};var $={name:"tabs",styleSheet:{selector:"default",styleSheetList:{default:{"tp-tabs":"","tp-tabs_top":"","tp-tabs_label.checked":" ","tp-tabs_main":" ","tp-tab_main.checked":" "}}},styleSheetLoadList:{},styleFn:()=>{},state:{count:0},tpComponentDeleteFn:function(){console.log(this)},tpComponentMonitorCmd:()=>{},tpComponentCmdFn:{tabAdd:(t,a)=>{let n=document.createElement("div");n.setAttribute("contenteditable",!1),n.setAttribute("class","tp-partition tp-tabs_label"),n.setAttribute("data-idx",t.tp$state.count);let e=document.createElement("p");e.setAttribute("class","tp-component_inline"),e.setAttribute("data-idx",t.tp$state.count),e.setAttribute("contenteditable",!0),e.innerHTML=a.title,n.appendChild(e),t.insertBefore(n,t.lastChild);let i=document.createElement("div");i.setAttribute("class","tp-tab_main"),i.setAttribute("style","overflow: hidden; max-height: 0; transition: all 0s"),i.innerHTML=a.content,t.lastChild.appendChild(i),t.tp$state.count++},tabDelete:(t,a)=>{t.children[--t.tp$state.count].remove(),t.lastChild.lastChild.remove()},delete:(t,a)=>{t.remove()},getStyle:(t,a)=>{},setStyle:(t,a)=>{console.log(t.querySelector(".tp-tabs_top")),t.setAttribute("data-top-style",a["tp-tabs_top"]),t.shadowRoot.querySelector(".tp-tabs_top").setAttribute("style",a["tp-tabs_top"])}},template:{innerHTML:`
<div class="tp-tabs">
...
<div class="tp-buttons_main">
    ...
    `},styleSheetList:{default:{"tp-buttons":`
          ...
          text-decoration: none;`,"tp-buttons:hover":`
           ...
           `,"tp-buttons::before":" ","tp-buttons::after":" "}},isContentEditable:!0,connectedCallback:()=>{},tpComponentCmdFn:{upData:(t,a)=>{t.shadowRoot.children[1].textContent=E(a.editor.tp$CustomTags.buttons.styleSheetList[a.styleName],a.styleName).replace(/\[data-tp-style=(.*?)\]/g,"").replace(/>/g," ").replace(/.tp-buttons\s*\{/g,":host   {").replace(/.tp-buttons:hover\s*\{/g,":host(:hover)   {").replace(/.tp-buttons::before\s*\{/g,":host(::before)   {").replace(/.tp-buttons::after\s*\{/g,":host(::after)   {")}},contentEditableFn:(t,a,n,e)=>{if(t.firstChild&&t.firstChild.tagName==="A"){const i=document.createElement("p");i.setAttribute("contenteditable",!0),i.setAttribute("class","tp-component_inline"),t.firstChild.innerHTML="<span>"+t.firstChild.innerHTML+"</span>",t.firstChild.setAttribute("href","javascript:;"),i.appendChild(t.firstChild),t.appendChild(i)}},isHeaderEditable:!0,parserFn:(t,a,n)=>{t.attr({"data-tp-component":null});let e=t.attr("style"),i={},o="";o=h("margin",e),o&&(i.margin=o),o=h("padding",e),o&&(i.padding=o),o=h("border",e),o&&(i.border=o),o=h("background",e),o&&(i.background=o),o=h("border-radius",e),o&&(i["border-radius"]=o),o=h("border-width",e),o&&(i["border-width"]=o),o=h("border-style",e),o&&(i["border-style"]=o),o=h("border-color",e),o&&(i["border-color"]=o);let r=new f("div",1);r.type=1,r.attr({"data-mce-tp-component":a,"data-tp-style":t.attr("data-tp-style")||"default",style:v(i)||null,"data-id":t.attr("data-id")}),t.attr("class")&&r.attr("class",t.attr("class")),n.tp$Style.mapping||(n.tp$Style.mapping={}),n.tp$Style.mapping[""+t.attr("data-id")]?m(n.tp$Style.mapping[""+t.attr("data-id")],{styleTemplate:t.attr("data-tp-style")||"default"}):n.tp$Style.mapping[""+t.attr("data-id")]={styleCustomTags:"buttons",stylePath:"styleSheetList",styleTemplate:t.attr("data-tp-style")||"default",specialStyle:{}},t.attr("style",v(m(F(t.attr("style"))||{},{margin:"",padding:"",background:"","border-style":"","border-color":"","border-width":"","border-radius":"",border:""}))||null),t.attr("data-id",null),t.attr("data-mce-style",null),t.wrap(r),r.name="tp-"+a},serializerFn:(t,a)=>{let n=t;for(;n.name!=="a"&&n.firstChild.name!=="#text";)n=n.firstChild;t.attr({"data-mce-tp-component":null,"data-tp-component":a,contenteditable:null,"data-tp-style":t.attr("data-tp-style")||"default",href:n&&n.attr("href")?n.attr("href"):null,style:n&&n.attr("style")?v(m(F(t.attr("style"))||{},F(n.attr("style"))||{})):t.attr("style"),target:n&&n.attr("target")?n.attr("target"):null,rel:n&&n.attr("rel")?n.attr("rel"):null,title:n&&n.attr("title")?n.attr("title"):null}),t.firstChild.unwrap(),n&&n.unwrap(),t.name="a"}},N={name:"collapse",template:{innerHTML:`
...
<div class="tp-collapse_mainBox">
    ...
    `},isContentEditable:!0,connectedCallback:()=>{},tpComponentCmdFn:{upData:(t,a)=>{let n=a.style,e=h("padding",n),i=h("border",n),o=h("border-width",n);H(a.editor,t,"tp-collapse_main",(e?"padding: "+e+"!important; ":"")+(i?"border: "+i+"!important;":"")+(o?"border-width: "+o+"!important;":""))}},contentEditableFn:(t,a,n,e)=>{const i=document.createElement("div");if(i.setAttribute("contenteditable",!1),i.setAttribute("class","tp-partition tp-collapse_main"),a&&t.lastChild.setAttribute("contenteditable",!0),t.lastChild.getAttribute("class")==="tp-collapse_main"){let o=t.lastChild.getAttribute("style"),r=h("padding",o),s=h("border",o),l=h("border-width",o);H(e,t,"tp-collapse_main",(r?"padding: "+r+"!important; ":"")+(s?"border: "+s+"!important;":"")+(l?"border-width: "+l+"!important;":""))}i.appendChild(t.lastChild),t.appendChild(i)},isHeaderEditable:!0,headerEditableFn:(t,a,n,e)=>{if(t.firstChild.contenteditable!=="true"){const i=document.createElement("div");for(a&&i.setAttribute("contenteditable",!0),i.setAttribute("slot","header"),i.setAttribute("class","tp-collapse_label"),i.setAttribute("style","min-height: 20px; "+t.getAttribute("data-top-style"));t.firstChild&&t.firstChild.className!=="tp-"+n+"_main";)i.appendChild(t.firstChild);t.insertBefore(i,t.firstChild)}},parserFn:(t,a)=>{t.attr({"data-tp-component":null,"data-mce-tp-component":a}),t.attr("data-id",t.firstChild.attr("id")),t.firstChild.remove(),t.lastChild.attr("class","tp-"+a+"_main"),t.type=1,t.name="tp-"+a},serializerFn:(t,a)=>{t.attr({"data-mce-tp-component":null,"data-tp-component":a,contenteditable:null,class:"tp-"+a}),t.firstChild.type=1,t.firstChild.name="label",t.firstChild.attr({contenteditable:null,for:t.attr("data-id")});let n=t.lastChild.attr("style");t.lastChild.unwrap(),t.lastChild.attr({contenteditable:null,class:"tp-"+a+"_main",style:n});let e=new f("input",1);e.shortEnded=!0,e.attr({id:t.attr("data-id"),type:"checkbox"}),t.insert(e,t.firstChild,!0),t.attr("data-id",null),t.type=1,t.name="div"}};const R=t=>/select$/.test(t),O={forecolor:!0,backcolor:!0,tpLetterspacing:!0,tpIconlists:!0,tpColumns:!0,table:!0},w={title:{file:{zh_CN:"\u6587\u4EF6",en_US:"File"},edit:{zh_CN:"\u7F16\u8F91",en_US:"Edit"},view:{zh_CN:"\u67E5\u770B",en_US:"View"},insert:{zh_CN:"\u63D2\u5165",en_US:"Insert"},format:{zh_CN:"\u683C\u5F0F",en_US:"Format"},table:{zh_CN:"\u8868\u683C",en_US:"Table"},tools:{zh_CN:"\u5DE5\u5177",en_US:"Tools"},help:{zh_CN:"\u5E2E\u52A9",en_US:"Help"}},items:{code:"tools",spellchecker:"tools",spellcheckerlanguage:"tools",wordcount:"tools",image:"insert",link:"insert",media:"insert",hr:"insert",template:"insert",codesample:"insert",charmap:"insert",inserttable:"table",emoticons:"insert",pagebreak:"insert",nonbreaking:"insert",anchor:"insert",toc:"insert",insertdatetime:"insert",bold:"format",italic:"format",underline:"format",strikethrough:"format",blockquote:"format",subscript:"format",superscript:"format",removeformat:"format",formatselect:"format",fontselect:"format",fontsizes:"format",forecolor:"format",backcolor:"format",fontformats:"format",blockformats:"format",codeformat:"format",align:"format",table:"table",lineheight:"format",help:"help"}},j={file:!0,view:!0,edit:!0},U=t=>{let a=[];return t.split("|").forEach(e=>{let i=e.split(" "),o=[];i.forEach(r=>{r&&o.push({isSelect:R(r),name:r}),r&&w.items[r]&&(j[w.items[r]]=!0)}),o.length>0&&a.push(o)}),a},mt=t=>{let a=[];return t.split("|").forEach(e=>{let i=e.split(" "),o=[];i.forEach(r=>{r&&o.push({isSelect:R(r),name:r})}),a.push(o)}),a},J=()=>`.skt-tox-tinymce{
  ...
  .skt-loading .skeleton.badge:after {
  background-color: #f8fafc
  }`,bt=t=>{if(!document.querySelector("style#skt-tox-style")){let l=document.createElement("style");l.type="text/css",l.id="skt-tox-style";try{l.appendChild(document.createTextNode(J()))}catch{l.styleSheet.cssText=J()}document.getElementsByTagName("head")[0].appendChild(l)}if(!document.querySelector("style#skt-dark-tox-style")){let l=document.createElement("style");l.type="text/css",l.id="skt-dark-tox-style";try{l.appendChild(document.createTextNode(K()))}catch{l.styleSheet.cssText=K()}document.getElementsByTagName("head")[0].appendChild(l)}let a=[];typeof t.toolbar=="string"?a=U(t.toolbar):Array.isArray(t.toolbar)&&t.toolbar.forEach(l=>{a.push(...U(l))});let n=[];if(t.menubar!==!1)if(typeof t.menubar=="string")n=mt(t.menubar);else for(let l in w.title)j[l]&&n.push(w.title[l][t.language||"en_US"]);let e=t.min_height||t.height||200,i=[],o=e-150;for(let l=0;l<o;l+=50)i.push("1");let r=t.selector?document.querySelector(t.selector).parentNode:t.target.parentNode,s=document.createElement("div");return s.className="skt skt-loading",/dark$/.test(t.skin)&&s.setAttribute("data-isdark","true"),s.innerHTML=Ct({selector:t.selector,toolbar:a,menubar:n,branding:t.branding!==!1,placeholderList:i,height:e}),r.style.position="relative",r.style.minHeight=e+"px",r.append(s),s},xt=t=>{let a="";return t.forEach(n=>{typeof n=="object"?n.forEach(e=>{a+='<button  class="skt-tox-mbtn skt-tox-mbtn--select"><span class="skt-tox-mbtn__select-label skeleton">'+e+`</span></button>
...
`,n.forEach(e=>{a+='<button class="skt-tox-tbtn '+(e.isSelect?" skt-tox-tbtn--select":"")+(O[e.name]?" skt-tox-split-button":"")+'"><span class="'+(e.isSelect?"skt-tox-tbtn__select-label skt-tox-tbtn--select":"skt-tox-icon tox-tbtn__icon-wrap")+' skeleton">'+e.name+"</span>"+(e.isSelect||O[e.name]?'<div class="skt-tox-tbtn__select-chevron skeleton"></div>':"")+`</button>
`}),a+=`</div>
...
</div>`;g.customTags[$.name]=$,g.customTags[V.name]=V,g.customTags[N.name]=N;let vt=(t,a,n)=>{let e=`
`;for(let i=0;i<n;i++)e+=`.tp-${t} > input:nth-child(${i+1}):checked ~ .tp-${t}_top > .tp-${t}_label:nth-child(${i+1}){${a}}
            ...
            `;return e},kt=(t,a)=>{let n="";return L(t.specialStyle).forEach(e=>{n+=t.specialStyle[e]?`
 `+a[e]+" { "+t.specialStyle[e]+"} ":""}),n},Et=t=>{t.tp$OutputStyle="";let a=2,n="",e="",i="",o="",r={},s={},l={};t.tp$Style&&t.tp$Style.mapping&&(!t.tp$CustomTags&&(t.tp$CustomTags=JSON.parse(JSON.stringify(g.customTags))),L(t.tp$Style.mapping).forEach(x=>{let p=t.tp$Style.mapping[x];p.styleCustomTags==="tabs"&&(r[p.styleTemplate]||(n=t.tp$CustomTags[p.styleCustomTags][p.stylePath][p.styleTemplate],r[p.styleTemplate]=!0),a<p.quantity&&(a=p.quantity)),p.styleCustomTags==="collapse"&&(s[p.styleTemplate]||(i+=t.tp$CustomTags[p.styleCustomTags][p.stylePath][p.styleTemplate],s[p.styleTemplate]=!0),o+=p.specialStyle?kt(p,{"tp-collapse_main":'.tp-collapse > input[id="'+x+'"]:checked + .tp-collapse_label + .tp-collapse_main'}):""),p.styleCustomTags==="buttons"&&!l[p.styleTemplate]&&(e+=E(t.tp$CustomTags[p.styleCustomTags][p.stylePath][p.styleTemplate],p.styleTemplate),l[p.styleTemplate]=!0)}));let u="",c="";n&&(n=n.replace(/.tp-tabs\s*{/g,"div.tp-tabs[data-id] {").replace(/\n.tp-tabs\s/g,`
.tp-tabs[data-id] `)+`.tp-tabs[data-id] > input { display: none;} 
 .tp-tabs .tp-tabs_main .tp-tab_main { overflow: hidden;max-height: 0px;}`,u=n.match(/.tp-tabs_label.checked\s*{\n([\s\S]+)\n}/)[1],c=u?vt("tabs",u,a):""),t.tp$OutputStyle=(e?`@font-face {
...
}`:"")+e+i+o+n+c};const wt={iframeLayout:`
   <style>
